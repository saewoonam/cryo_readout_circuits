...
templateReferences = ['IC201', 'IC202', 'D201', 'L201', 
...
inputBoard = './diode_readout.kicad_pcb'
#Output file, original file remains unmodified
outputBoardFile = './scriptoutput.kicad_pcb'
...
move_dy = FromMM(30)		#Spacing between clones in y direction
